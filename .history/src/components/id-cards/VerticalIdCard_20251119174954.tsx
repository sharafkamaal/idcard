  ...
  return (
    <div className="relative w-56 h-80 rounded-lg overflow-hidden shadow-xl bg-white">
      ...
      <div className="absolute inset-0 px-0 py-0 flex flex-col items-center">
        ...
        {/* Student Photo */}
        {studentPhotoUrl && (
          <div className="w-28 h-32 rounded-md mb-3 bg-white overflow-hidden shadow-md border-2 border-blue-700 mx-auto flex-shrink-0">
            <Image
              src={studentPhotoUrl}
              alt="Student"
              width={112}
        ...
        {/* Details */}
        <div className="w-full max-w-[10rem] mx-auto flex flex-col items-start justify-start px-2 space-y-0.5">
          ...
          {(classValue || section) && (
            <p className="text-[11px] text-gray-700 leading-tight">
              ...
              {classValue && section && <span className="mx-1">|</span>}
              {section && (
                <>
