                    ...
                    <div className="flex-1 min-w-0">
                      <div className="space-y-6 w-full">
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                ...
                                >
                                  <FormItem className="flex items-center gap-3 cursor-pointer text-base">
                                    <FormControl>
                                  ...
                                  <FormItem className="flex items-center gap-3 cursor-pointer text-base">
                                    ...
                                    <FormLabel className="font-normal">Multi Branch</FormLabel>
                                  </FormItem>
                                </RadioGroup>
                              </FormControl>
                              <FormMessage />
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel>Point of Contact Phone No</FormLabel>
                              <FormControl>
